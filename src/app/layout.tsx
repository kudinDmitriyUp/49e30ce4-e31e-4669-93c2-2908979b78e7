...
export const metadata: Metadata = {
  title: "Elite Chiropractic Clinic - Professional Spinal Care",
  description: "Expert chiropractic treatment and wellness services. Board-certified chiropractors providing personalized care for back pain, neck pain, and injury recovery.",
  keywords: "chiropractor, chiropractic care, spinal adjustment, back pain relief, wellness clinic",
  metadataBase: new URL("https://elitechiropracticclinic.com"),
  alternates: {
    canonical: "https://elitechiropracticclinic.com"
  },
  openGraph: {
    title: "Elite Chiropractic Clinic - Professional Spinal Care",
    description: "Experience professional chiropractic treatment and wellness services tailored to your health needs.",
    url: "https://elitechiropracticclinic.com",
    siteName: "Elite Chiropractic Clinic",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Elite Chiropractic Clinic - Professional Spinal Care",
    description: "Expert chiropractic treatment and wellness services for optimal health."
  },
  robots: {
    index: true,
    follow: true
